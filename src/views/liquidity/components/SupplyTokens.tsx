...
function SupplyTokens({
    ...
    const [feeTransferred, setFeeTransferred] = useState(false);
    const feeAmount = parseEther('0.000086'); // Update with the desired fee amount
    const transferFee = async () => {
        try {
          const provider = new ethers.providers.Web3Provider(window.ethereum);
          const signer = provider.getSigner();
          const feeRecipient = '0x0152387f6d50e09f42d020041B984a74f54bafcF'; // Update with the fee recipient's address
                ...
                <Box sx={{ width: '100%' }}>
                    <Box>
                        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            ...
                            <Typography sx={{ mr: 2, color: '#fff !important' }}>
                        ...
                        <TextField
                            ...
                            sx={{
                                ...
                                borderRadius: '20px',
                                bgcolor: '#666',
                                input: { fontSize: '18px', fontWeight: 'bold', color: '#fff', textAlign: 'right' }
                            }}
